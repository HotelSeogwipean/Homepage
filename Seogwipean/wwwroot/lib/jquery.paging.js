...
!function ($) {
    ...
    var a = /a/i, defs ={
        item: 'a',
        next: '<i class="right chevron icon t-black"></i>',
        prev: '<i class="left chevron icon t-black"></i>',
        format: '{0}',
        itemClass: "paging-item", sideClass: "paging-side", className: "jquery-paging", itemCurrent: "selected",
        length: 5,
        max: 1,
        current: 1,
        append: false,
        href: '#{0}',
        event: true,
        first: '<i class="left chevron icon t-black"></i><i class="left chevron icon t-black"></i>',
        last: '<i class="right chevron icon t-black"></i><i class="right chevron icon t-black"></i>'
    },
        format = function (str) {
            var arg = arguments;
